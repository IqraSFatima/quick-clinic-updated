...
const AddDoctor = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            <p className='mb-3 text-lg text-emerald-500 font-medium'>Add Doctor</p>
            ...
            <div className='bg-white px-8 py-8 border border-gray-100 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <input onChange={(e) => setFee(e.target.value)} value={fee} className='border border-gray-300 rounded px-3 py-2' type="number" placeholder="Fee" required />
                        </div>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={(e) => setSpeciality(e.target.value)} value={speciality} className='border border-gray-300 rounded px-3 py-2' >
                ...
                <div>
                    ...
                    <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full px-4 py-2 border border-gray-200 rounded' placeholder='Write about doctor' rows={5} required></textarea>
                </div>
                <button type="submit" className='bg-emerald-500 px-10 py-3 mt-4 text-white rounded-full font-semibold cursor-pointer hover:bg-emerald-600 transition-all duration-300'>
                    Add Doctor
                </button>
            </div>
        </form>
