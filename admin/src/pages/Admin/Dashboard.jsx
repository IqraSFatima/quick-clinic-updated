...
const Dashboard = () => {
  const { aToken, getDashData, cancelAppointment, dashData, getAllAppointments } = useContext(AdminContext);
      ...
      <div className='flex flex-wrap gap-5'>
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all duration-300'>
          ...
          <div>
            ...
            <p className='text-xs font-semibold text-gray-500'>Doctors</p>
          </div>
        </div>
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all duration-300'>
